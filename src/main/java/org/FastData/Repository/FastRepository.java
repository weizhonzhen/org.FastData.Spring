...
import org.FastData.Annotation.FastData;
import org.FastData.Annotation.Table;
import org.FastData.Base.DataConfig;
import org.FastData.Base.MapXml;
import org.FastData.CacheModel.DbConfig;
import org.FastData.CacheModel.MapConfig;
import org.FastData.CacheModel.MapXmlModel;
import org.FastData.CacheModel.PropertyModel;
import org.FastData.Check.BaseTable;
import org.FastData.Config.Config;
import org.FastData.Context.DataContext;
import org.FastData.Model.*;
import org.FastData.Util.CacheUtil;
import org.FastData.Util.ScanPackage;
...
@Configuration
@ComponentScan(basePackages = "org.FastData.Repository")
public class FastRepository implements IFastRepository {
    ...
    public void init() {
        try {
            ...
            FastData annotation = Thread.currentThread().getContextClassLoader().loadClass(mainClass).getAnnotation(org.FastData.Annotation.FastData.class);
